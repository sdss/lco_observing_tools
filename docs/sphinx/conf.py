...
try:
    from lco_observing_tools import __version__
except ModuleNotFoundError:
    from sdsstools import get_package_version
    __version__ = get_package_version(__file__, 'sdss-lco_observing_tools') or 'dev'
...
.. |lco_observing_tools_version| replace:: {__version__}
"""
...
htmlhelp_basename = '{0}pdoc'.format('lco_observing_tools')
...
man_pages = [
    (master_doc, 'lco_observing_tools', u'{0} Documentation'.format(project),
     [author], 1)
]
...
if use_releases == 'yes':
    ...
    releases_github_path = 'sdss/lco_observing_tools'
